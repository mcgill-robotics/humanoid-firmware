...
namespace servo_node
{
  ...
  class ServoFeedback : public ros::Msg
  {
    public:
      ...
      uint32_t torso_pitch_fb_length;
      typedef float _torso_pitch_fb_type;
      _torso_pitch_fb_type st_torso_pitch_fb;
      _torso_pitch_fb_type * torso_pitch_fb;
    ...
    ServoFeedback():
      ...
      torso_pitch_fb_length(0), st_torso_pitch_fb(), torso_pitch_fb(nullptr),
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 0) = (this->torso_pitch_fb_length >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->torso_pitch_fb_length >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->torso_pitch_fb_length >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->torso_pitch_fb_length >> (8 * 3)) & 0xFF;
      offset += sizeof(this->torso_pitch_fb_length);
      for( uint32_t i = 0; i < torso_pitch_fb_length; i++){
      union {
        float real;
        uint32_t base;
      } u_torso_pitch_fbi;
      u_torso_pitch_fbi.real = this->torso_pitch_fb[i];
      *(outbuffer + offset + 0) = (u_torso_pitch_fbi.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_torso_pitch_fbi.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_torso_pitch_fbi.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_torso_pitch_fbi.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->torso_pitch_fb[i]);
      }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      uint32_t torso_pitch_fb_lengthT = ((uint32_t) (*(inbuffer + offset))); 
      torso_pitch_fb_lengthT |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1); 
      torso_pitch_fb_lengthT |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2); 
      torso_pitch_fb_lengthT |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3); 
      offset += sizeof(this->torso_pitch_fb_length);
      if(torso_pitch_fb_lengthT > torso_pitch_fb_length)
        this->torso_pitch_fb = (float*)realloc(this->torso_pitch_fb, torso_pitch_fb_lengthT * sizeof(float));
      torso_pitch_fb_length = torso_pitch_fb_lengthT;
      for( uint32_t i = 0; i < torso_pitch_fb_length; i++){
      union {
        float real;
        uint32_t base;
      } u_st_torso_pitch_fb;
      u_st_torso_pitch_fb.base = 0;
      u_st_torso_pitch_fb.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_torso_pitch_fb.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_torso_pitch_fb.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_torso_pitch_fb.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->st_torso_pitch_fb = u_st_torso_pitch_fb.real;
      offset += sizeof(this->st_torso_pitch_fb);
        memcpy( &(this->torso_pitch_fb[i]), &(this->st_torso_pitch_fb), sizeof(float));
      }
    ...
    virtual const char * getMD5() override { return "0167e327c72231a86d591a575a8a53b4"; };
