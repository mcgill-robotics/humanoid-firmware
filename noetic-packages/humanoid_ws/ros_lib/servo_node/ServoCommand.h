...
namespace servo_node
{
  ...
  class ServoCommand : public ros::Msg
  {
    public:
      ...
      typedef float _torso_pitch_setpoint_type;
      _torso_pitch_setpoint_type torso_pitch_setpoint;
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (u_torso_yaw_setpoint.base >> (8 * 3)) & 0xFF;
      ...
      union {
        float real;
        uint32_t base;
      } u_torso_pitch_setpoint;
      u_torso_pitch_setpoint.real = this->torso_pitch_setpoint;
      *(outbuffer + offset + 0) = (u_torso_pitch_setpoint.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_torso_pitch_setpoint.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_torso_pitch_setpoint.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_torso_pitch_setpoint.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->torso_pitch_setpoint);
      union {
        float real;
        uint32_t base;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_torso_pitch_setpoint.base = 0;
      u_torso_pitch_setpoint.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_torso_pitch_setpoint.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_torso_pitch_setpoint.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_torso_pitch_setpoint.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->torso_pitch_setpoint = u_torso_pitch_setpoint.real;
      offset += sizeof(this->torso_pitch_setpoint);
      union {
        float real;
        uint32_t base;
    ...
    virtual const char * getMD5() override { return "e5b7542b7fed3bafc8ce2abc9a0673e1"; };
